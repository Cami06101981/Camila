...
# MAGIC %md 
# MAGIC ## ![Delta Lake Tiny Logo](https://pages.databricks.com/rs/094-YMS-629/images/delta-lake-tiny-logo.png) Building Reliable and Performant Data lake with Delta

# COMMAND ----------

# MAGIC %md
# MAGIC <img src="http://www.fabiofialho.com.br/wp-content/uploads/2018/05/word-image.png" width = "700"/> <img src="http://www.fabiofialho.com.br/wp-content/uploads/2018/05/word-image-1.png" width = "700"/>
...
# MAGIC %sql
# MAGIC select * from loan_by_state limit 10;
...
# MAGIC %fs head /ml/loan_by_state_delta/_delta_log/00000000000000000000.json
